...
class SlidePuzzle:
    def __init__(self, gs, ts, ms, w_screen, h_screen):
        ...
        font = pygame.font.Font('./font/Roboto-Bold.ttf', 46*2)
        ...
        self.back_button = pygame.transform.scale(self.back_button, (self.w/2, self.h/2))
        self.retry = pygame.image.load('./ui_button/back_button.png')
        self.retry = pygame.transform.scale(self.retry, (self.w/2, self.h/2))
        self.retry = pygame.transform.rotate(self.retry, 180)
    ...
    def update(self, pos, cond, win_cnt):
        """
    ...
    def draw(self, screen, win_cnt):
        ...
        font = pygame.font.Font('./font/Roboto-Bold.ttf', 30*2)
        ...
        if self.finish == 1:
            ...
            congrat = pygame.transform.scale(congrat, (1829, 430))
        ...
        self.blit_text(screen, self.text[2], (self.retry.get_width(), self.h_screen-self.retry.get_height()), pygame.font.Font('./font/Roboto-Light.ttf', 24*2))
